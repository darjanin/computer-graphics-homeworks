    ...
    public partial class Form1 : Form
    {
        ...
        protected override void OnMouseClick(MouseEventArgs e)
        {
            ...
            if ((e.Button == System.Windows.Forms.MouseButtons.Right) && (rbCohen.Checked))
            {
                ...
                //Info: Start clipping and set min/max box and Lines to CS algorithm
                System.Diagnostics.Debug.WriteLine(StartPoint.X.ToString() + "x" + StartPoint.Y.ToString());
                System.Diagnostics.Debug.WriteLine(EndPoint.X.ToString() + "x" + EndPoint.Y.ToString());
